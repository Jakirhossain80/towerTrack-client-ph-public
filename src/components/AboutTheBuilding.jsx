...
const features = [
  {
    ...
    title: "24/7 Security",
    description:
      "Advanced surveillance system and smart access control ensure complete safety.",
  },
  {
    icon: <MdElevator className="text-lime-500 dark:text-lime-400 w-6 h-6" />,
    title: "Smart Elevators",
    description:
      "High-speed, sensor-enabled elevators for convenient vertical transport.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Sustainable architecture with energy-saving and recycling systems.",
  },
  {
    icon: <FaWifi className="text-lime-500 dark:text-lime-400 w-6 h-6" />,
    title: "High-Speed Wi-Fi",
    description:
      "Building-wide internet access to keep all residents connected at all times.",
  },
  {
    icon: <MdPayment className="text-lime-500 dark:text-lime-400 w-6 h-6" />,
    title: "Digital Payments",
    description:
      "Pay your rent, utilities, and service fees securely through the TowerTrack dashboard.",
  },
  {
    icon: (
      <FaPeopleArrows className="text-lime-500 dark:text-lime-400 w-6 h-6" />
    ),
    title: "Community Portal",
    description:
      "Stay engaged with neighbors, announcements, and events in a private social space.",
  },
  {
    icon: <FaBell className="text-lime-500 dark:text-lime-400 w-6 h-6" />,
    title: "Maintenance Alerts",
    description:
      "Get real-time notifications about maintenance schedules, water/electricity issues, and more.",
  },
  {
    icon: (
      <AiFillControl className="text-lime-500 dark:text-lime-400 w-6 h-6" />
    ),
    title: "Centralized Control",
    description:
      "Manage apartment utilities and service requests from a single platform.",
  },
];
      ...
      <div className=" mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-700 dark:text-gray-300 text-base sm:text-lg font-inter max-w-2xl mx-auto">
            TowerTrack is built to redefine modern apartment living — offering a
            blend of comfort, technology, and community for residents, members,
            and admins alike.
          </p>
        </div>
